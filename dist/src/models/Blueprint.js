...
const BlueprintSchema = new mongoose_1.Schema({
    ...
    blueprint_json: { type: mongoose_1.Schema.Types.Mixed },
    threejs_json: { type: mongoose_1.Schema.Types.Mixed },
    uploaded_by: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
    created_at: { type: Date, default: Date.now },
});
exports.default = mongoose_1.default.model('Blueprint', BlueprintSchema);
